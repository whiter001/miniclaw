...
fn print_help() {
	...
	println('  miniclaw channels status   Show Weixin login status')
	println('  miniclaw channels login --channel weixin   Start local Weixin login flow and write an SVG QR image')
